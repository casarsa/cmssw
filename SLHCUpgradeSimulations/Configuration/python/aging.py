...
def ageMTD(process,lumi):
    ...
    mtd_parameters = {
        1000: {
            ...
            "timewalk_corr_offset": "-0.00052*x-0.00033" # this is an ad hoc correction to remove a bias in the RecHit time
        },
        3000: {
            "light_output": 1004.,
            "dark_count_rate": 20.,
            ...
            "timewalk_corr_offset": "-0.00058*x-0.00027" # this is an ad hoc correction to remove a bias in the RecHit time
        },
    }
        ...
        if hasattr(process,'mtdUncalibratedRecHits') and hasattr(process.mtdUncalibratedRecHits,'barrel'):
            ...
            process.mtdUncalibratedRecHits.barrel.timeWalkCorrection = cms.string(
                "{}/{}*pow({}/{}*(x-{}),{}){}".format( mtd_parameters[lumi]["time_at_thr1rise"][0],
                                                       ...
                                                       mtd_parameters[lumi]["timewalk_corr_offset"]
                                                      )
            )
